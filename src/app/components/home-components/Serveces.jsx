            ...
            <div className="row row-gap-5">
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="row align-items-center">
                  ...
                  <div className="col-10">
                    <h4>
                      شركة السيد علاء تقدم أسعار تنافسية بجودة ونتائج متميزة في
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="row align-items-center">
                  ...
                  <div className="col-10">
                    <h4>
                      تقدم شركة السيد علاء ماكينات حديثة للرخام والجرانيت لتعزيز
                      جودة الإنتاج لدى أصحاب المصانع والورش.
                    </h4>
                  </div>
                </div>
              </div>
